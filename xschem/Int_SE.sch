...
C {sky130_fd_pr/cap_mim_m3_1.sym} 50 -130 3 0 {name=C2 model=cap_mim_m3_1 W=350 L=350 MF=6 spiceprefix=X}
...
C {devices/opin.sym} 350 20 0 0 {name=p6 lab=vout}
...
C {devices/ipin.sym} -50 160 3 0 {name=p4 lab=vin_p}
...
C {devices/gnd.sym} -500 160 0 0 {name=l5 lab=GND}
