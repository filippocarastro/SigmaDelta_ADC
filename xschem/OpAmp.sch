...
C {devices/lab_wire.sym} 1272.5 -500 0 0 {name=l1 sig_type=std_logic lab=vdd
}
C {devices/lab_wire.sym} 1275 -440 0 0 {name=l2 sig_type=std_logic lab=iref

}
C {devices/lab_wire.sym} 1405 -360 0 0 {name=l4 sig_type=std_logic lab=vp}
C {devices/lab_pin.sym} 1767.5 -440 0 0 {name=l5 sig_type=std_logic lab=iref}
C {devices/lab_wire.sym} 1442.5 40 0 0 {name=l7 sig_type=std_logic lab=vss
}
C {devices/lab_wire.sym} 1977.5 -240 0 0 {name=l8 sig_type=std_logic lab=vout
}
C {devices/lab_wire.sym} 1450 -65 0 0 {name=l6 sig_type=std_logic lab=vbn}
...
C {devices/lab_pin.sym} 1720 -250 2 0 {name=l9 sig_type=std_logic lab=vdd
}
C {devices/lab_pin.sym} 1720 -110 2 0 {name=l10 sig_type=std_logic lab=vss
}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1830 -190 3 0 {name=C1 model=cap_mim_m3_1 W=17.55 L=15 MF=6 spiceprefix=X}
C {devices/iopin.sym} 950 -500 2 0 {name=p11 lab=vdd}
C {devices/iopin.sym} 950 40 2 0 {name=p2 lab=vss}
C {devices/ipin.sym} 1180 -270 0 0 {name=p3 lab=vin_n}
C {devices/ipin.sym} 1670 -270 2 0 {name=p4 lab=vin_p}
C {devices/ipin.sym} 950 -360 0 0 {name=p5 lab=iref}
...
C {devices/lab_wire.sym} 1630 -190 0 0 {name=l3 sig_type=std_logic lab=voe1}
C {devices/opin.sym} 2030 -240 0 0 {name=p6 lab=vout}
