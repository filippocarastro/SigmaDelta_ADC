...
C {devices/isource.sym} -310 100 0 0 {name=I0 value=DC\{iref\}}
...
C {devices/vsource.sym} -740 -160 0 0 {name=V3 value="pulse vss vdd 0 1n 1n 9n 20n"}
C {devices/vsource.sym} -550 -160 0 0 {name=V5 value="pulse vss vdd 10n 1n 1n 9n 20n"}
...
*Simulations
.control
  save v(x2.VINV) v(x1.vc1) v(x2.vc2) v(x3.vcomp_n)
  tran 0.1n 300n
  setplot tran1
  plot v(vsen) v(vout_Int) v(phi1) v(phi2) v(vout_dac)
  plot v(x1.vc1) - v(x1.vc2)
  plot v(x3.vcomp_n)
...
C {devices/vsource.sym} -340 -160 0 0 {name=V8 value="pwl 0 vdd 9n vdd 10n vss"}
C {devices/gnd.sym} -340 -90 0 0 {name=l31 lab=GND}
C {devices/lab_pin.sym} -340 -250 1 0 {name=l32 sig_type=std_logic lab=rst}
C {devices/lab_pin.sym} -310 170 3 0 {name=l5 sig_type=std_logic lab=vss}
...
C {devices/lab_pin.sym} 20 460 3 0 {name=l23 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 340 140 3 0 {name=l29 sig_type=std_logic lab=vss}
